        ...
        >
          ...
          <div className="relative">
            ...
            <motion.h1
              ...
              className="relative font-script text-7xl md:text-9xl lg:text-[10rem] leading-none text-cream-dark drop-shadow-2xl mix-blend-overlay"
            >
              Precious
            </motion.h1>
            ...
            <motion.h1
              ...
              className="relative font-script text-7xl md:text-9xl lg:text-[10rem] leading-none text-cream-dark drop-shadow-2xl"
            >
              Tony
            </motion.h1>
          </div>
